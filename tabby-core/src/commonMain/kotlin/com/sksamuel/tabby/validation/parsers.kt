...
/**
 * Widens an existing [Parser] String -> String to accept nulls, rejecting them and also blank strings.
 */
 ...
 */
fun <A, E> Parser<String, String, E>.minlen(len: Int, ifError: (String) -> E): Parser<String, String, E> =
   flatMap { if (it.length < len) ifError(it).invalid() else this@minlen.parse(it) }
