...
/**
 * Wraps an existing String -> String [Parser] to accept null input, which are
 * returned as invalid, with the error message generated by the given function [ifNull].
 *
